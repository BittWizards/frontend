...
const StatisticsAnalyticsContainer: FC<IStaticsAnalyticsContainerProps> = ({ diagramImage, classNameDiagram }) => (
  <div className={style.statisticsAnalytics}>
    ...
    <img className={classNameDiagram} src={diagramImage} alt='Диаграмма Прироста Амбассадоров' />
  </div>
);
